...
const getVideos = async (req, res) => {
  try {
    ...
    const videos = await Video.find(filter)
      .select('title description category examType chapterName youtubeId instructor duration isActive createdAt views classNotes.filename classNotes.uploadedAt quizPdf quizLink')
      .sort({ createdAt: -1 })
      .limit(100)
      .lean()
      .exec();
