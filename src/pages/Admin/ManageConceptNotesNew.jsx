...
const ManageConceptNotesNew = () => {
    ...
    const resetChapterForm = () => {
        ...
        setCurrentTopic({ title: '', content: '', images: [], concepts: [] });
        setCurrentConcept({ conceptName: '', content: '', images: [], practiceQuestions: [] });
        setCurrentQuestion({ question: '', options: ['', '', '', ''], correctAnswer: 0, explanation: '', difficulty: 'Medium' });
                        ...
                        <div className="bg-gray-800/50 p-4 rounded-lg space-y-4">
                            ...
                            <div className="flex justify-between items-center mb-2">
                                <label className="text-white font-semibold flex items-center gap-2">
                                    ...
                                    Topic Content (Optional - can add concepts directly)
                                </label>
                                <div className="relative">
                                    <input
                                        type="file"
                                        accept=".docx"
                                        onChange={(e) => handleDocxImport(e, 'topic')}
                                        className="hidden"
                                        id="docx-upload-topic"
                                    />
                                    <label
                                        htmlFor="docx-upload-topic"
                            ...
                            <div className="bg-white rounded-lg text-black">
                                <ReactQuill
                                    ...
                                    placeholder="Write topic overview here (optional)..."
                                />
                            </div>
...
export default ManageConceptNotesNew;
