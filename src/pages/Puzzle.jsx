...
const Puzzle = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Chemistry Puzzles - Brain Teasers & Problem Solving</title>
                <meta name="description" content="Challenge yourself with chemistry puzzles, brain teasers, and problem-solving exercises for JEE, NEET, and other competitive exams." />
            </Helmet>
