        ...
        <div className="space-y-6">
          <div className="glass-panel p-6 rounded-xl flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400">+91 9115179935</p>
            </div>
          </div>
          <div className="glass-panel p-6 rounded-xl flex items-center">
            <div className="w-12 h-12 bg-purple-900 rounded-full flex items-center justify-center text-purple-400 mr-4">
              <i className="fas fa-envelope"></i>
            </div>
            <div>
              <h4 className="font-bold text-lg">Email Address</h4>
              <p className="text-gray-400">crack@ace2examz.in</p>
            </div>
          </div>
          <div className="glass-panel p-6 rounded-xl flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400">Chhota Tiwana Rd, Jalalabad West, Distt - Fazilka (PB), 152024</p>
            </div>
          </div>
