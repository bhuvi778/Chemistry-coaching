            ...
            <div className="max-w-7xl mx-auto px-4 py-20">
                ...
                {!loading && view === 'concepts' && currentTopic && (
                    <div className="glass-panel rounded-2xl p-6">
                        ...
                        {/* Topic Overview (if exists) */}
                        {currentTopic.content && currentTopic.content.trim() !== '' && (
                            <div className="mb-6 p-4 bg-gray-800/30 rounded-lg border border-gray-700">
                                <h3 className="text-lg font-semibold text-cyan-400 mb-3">Topic Overview</h3>
                                <div
...
export default ConceptWiseNotesNew;
